...
function each(name, cb){
  for (var i = 0; i < name.length; i++) { // start at the beg of the array, keep going through the whole array, increment after each variable
    cb(name[i],i); //callback invoked, 
  }
}
